      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <a href="https://t.me/+XxxYyyZzz" target="_blank" rel="noopener" className="px-4 py-2 bg-sky-600/20 hover:bg-sky-600/30 border border-sky-500/30 rounded-lg text-sm font-medium text-sky-300 inline-flex items-center gap-1">
          ...
          <div className="space-y-3 text-sm text-white/70">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <a href="https://t.me/+XxxYyyZzz" target="_blank" rel="noopener" className="text-sky-400 hover:underline ml-1">
                  @zzmm_support
                </a>
